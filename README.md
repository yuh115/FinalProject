...
Using these submetrics, we will develop an overall metric for determining the best neighborhood in Pittsburgh. We then ranked each neighborhood based on this metric to determine the best neighborhood.

In the following sections, we will describe our metric in detail, explain how we analyzed each dataset, and present our findings.
